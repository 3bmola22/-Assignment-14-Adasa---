...
import BlogBage from "./Components/BlogPage/BlogPage";
import ThirdPage from "./Components/AboutUs/AboutUs";
import ErrPath from "./Components/ErrPath/ErrPath";
...
// ]);
// let mainNavbar = createBrowserRouter([
//   {
//     index: true,
//     Element: <Layout />,
//     children: [
...
function App() {
  ...
  let limitedPosts = artical.posts;
  // console.log("out" + first);
  // console.log(limitedPosts);

  function next() {
    setfirst(Math.min(22, first + 6));
    setsecond(Math.min(28, second + 6));
    // console.log("next" + first);
  }
  function back() {
    setfirst(Math.max(0, first - 6));
    setsecond(Math.max(6, second - 6));
  ...
  function portraitCategory() {
    ...
    setfirst(0);
    setsecond(6);
    console.log("portraitCategory");
  }
  function naturalCategory() {
    setactiveCategory("مناظر طبيعية");
    setfirst(0);
    setsecond(6);
    console.log("naturalCategory");
  }
  ...
  const filteredPosts = useMemo(() => {
    ...
    return posts;
  }, [activeCategory, searchQuery, artical.posts]);
  // }
  let x = createBrowserRouter([
    {
      path: "",
      element: <Layout siteInfo={artical.siteInfo} />,
      children: [
        {
          index: true,
          element: <Home />,
        ...
        { path: "aboutUs", element: <AbouUs /> },
        { path: "*", element: <ErrPath /> },
        {
          path: "blogBage/:slug",
          element: <Info limitedPosts={limitedPosts} />,
        },
      ],
    },
  ]);
